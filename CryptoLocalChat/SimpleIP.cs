...
/// (UPD: Теперь можно пихать стринги. Но правильность форматирования не проверяется)
...
namespace SimpleIP {
	...
	class TCPConnection {
		#region States
		public enum ConnectionState {Disconnected, ServerWaiting, ServerConnected, ClientConnecting, ClientConnected};
